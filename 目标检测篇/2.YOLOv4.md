...
$$
GIoU=IoU - \frac{C-B^{pred} \cup B^{gt}}{C} \\
Loss(GIoU)=1-GIoU
$$
...
$$
DIoU=\frac{ \rho(b, b^{gt})}{c^2} \\
Loss(DIoU)=1-IoU + \frac{ \rho(b, b^{gt})}{c^2}
$$
...
$$
Loss(CIoU)=1-IoU + \frac{ \rho(b, b^{gt})}{c^2} + \alpha v \\
